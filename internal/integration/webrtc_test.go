...
//
// DISABLED (Task 6 of PLAN_reflect_proxy_reimplementation): WebRTC proxy is
// disabled; source retained for reference. See PLAN_multi_docker_integration_tests.
//
...
func TestWebRTCGameExchange(t *testing.T) {
	t.Skip("WebRTC proxy is disabled (Task 6).")
