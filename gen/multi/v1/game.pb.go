...
var file_multi_v1_game_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0xe2, 0x01, 0x0a, 0x0b, 0x47, 0x61, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_multi_v1_game_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_multi_v1_game_proto_goTypes = []interface{}{
	...
	(*Game)(nil),               // 6: multi.v1.Game
}
var file_multi_v1_game_proto_depIdxs = []int32{
	6, // 0: multi.v1.CreateGameResponse.game:type_name -> multi.v1.Game
	6, // 1: multi.v1.GetGameResponse.game:type_name -> multi.v1.Game
	6, // 2: multi.v1.ListGamesResponse.games:type_name -> multi.v1.Game
	2, // 3: multi.v1.GameService.GetGame:input_type -> multi.v1.GetGameRequest
	4, // 4: multi.v1.GameService.ListGames:input_type -> multi.v1.ListGamesRequest
	0, // 5: multi.v1.GameService.CreateGame:input_type -> multi.v1.CreateGameRequest
	3, // 6: multi.v1.GameService.GetGame:output_type -> multi.v1.GetGameResponse
	5, // 7: multi.v1.GameService.ListGames:output_type -> multi.v1.ListGamesResponse
	1, // 8: multi.v1.GameService.CreateGame:output_type -> multi.v1.CreateGameResponse
