...
const (
	...
	PetStoreServiceName = "multi.v1.PetStoreService"
)
...
const (
	...
	PetStoreServiceGetPetProcedure = "/multi.v1.PetStoreService/GetPet"
	// PetStoreServicePutPetProcedure is the fully-qualified name of the PetStoreService's PutPet RPC.
	PetStoreServicePutPetProcedure = "/multi.v1.PetStoreService/PutPet"
	// PetStoreServiceDeletePetProcedure is the fully-qualified name of the PetStoreService's DeletePet
	// RPC.
	PetStoreServiceDeletePetProcedure = "/multi.v1.PetStoreService/DeletePet"
)

// PetStoreServiceClient is a client for the multi.v1.PetStoreService service.
...
// NewPetStoreServiceClient constructs a client for the multi.v1.PetStoreService service. By
...
// GetPet calls multi.v1.PetStoreService.GetPet.
...
// PutPet calls multi.v1.PetStoreService.PutPet.
...
// DeletePet calls multi.v1.PetStoreService.DeletePet.
...
// PetStoreServiceHandler is an implementation of the multi.v1.PetStoreService service.
...
func NewPetStoreServiceHandler(svc PetStoreServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/multi.v1.PetStoreService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPetStoreServiceHandler) GetPet(context.Context, *connect.Request[v1.GetPetRequest]) (*connect.Response[v1.GetPetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("multi.v1.PetStoreService.GetPet is not implemented"))
}
...
func (UnimplementedPetStoreServiceHandler) PutPet(context.Context, *connect.Request[v1.PutPetRequest]) (*connect.Response[v1.PutPetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("multi.v1.PetStoreService.PutPet is not implemented"))
}
...
func (UnimplementedPetStoreServiceHandler) DeletePet(context.Context, *connect.Request[v1.DeletePetRequest]) (*connect.Response[v1.DeletePetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("multi.v1.PetStoreService.DeletePet is not implemented"))
}
